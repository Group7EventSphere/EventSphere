...
class TicketControllerTest {
    ...
    @Test
    @DisplayName("GET /tickets/{id} returns 404 if not found")
    ...
    @Test
    @DisplayName("GET /tickets/attendee/{attendeeId} returns list of tickets")
    ...
    @Test
    @DisplayName("DELETE /tickets/{id} should delete and return 204")
    ...
    @Test
    @DisplayName("GET /tickets/code/{confirmationCode} returns ticket")
    void getTicketByConfirmationCode_shouldReturnTicket() throws Exception {
        ...
        mockMvc.perform(get("/tickets/code/TKT-ABC123"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.confirmationCode").value("TKT-ABC123"));
    }

    @Test
    @DisplayName("GET /tickets/count/{ticketTypeId} returns ticket count")
    void countByTicketTypeId_shouldReturnCount() throws Exception {
        ...
        mockMvc.perform(get("/tickets/count/" + ticketTypeId))
                .andExpect(status().isOk())
